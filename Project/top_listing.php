...
include 'database\config.php';
    ...
    $sql = "SELECT * FROM items WHERE category_id = '1' ORDER BY id ASC";
...
if(isset($_POST["sort"])){
    $sort=$_POST["sort"];
if ($sort=='price') {
    $sql = "SELECT * FROM items WHERE category_id = '1' ORDER BY price ASC";
} else if ($sort=='date') {
    $sql = "SELECT * FROM items WHERE category_id = '1' ORDER BY updated_at DESC";
    ...
    <div id="navbar">
        <nav>
            <ul>
                ...
                <li><a href="top_listing.php"class="active">Tops</a></li>
